...
exports.getAllUsers = catchAsync(async (req, res, next) => {
    ...
    const suggestedUsers = users.filter((u) => !u.followers.includes(req.params.userId) && u._id.toString() !== req.params.userId.toString()).slice(-5)
...
exports.updateProfile = catchAsync(async (req, res, next) => {
    ...
    const { name, username, website, bio, email, _id} = req.body;
...
exports.followUser = catchAsync(async (req, res, next) => {
    ...
    console.log("id", req.params.id,"and", req.params.userId)
