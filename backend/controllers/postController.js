...
exports.deletePost = catchAsync(async (req, res, next) => {
    ...
    if (post.postedBy.toString() !== req.params.userId.toString()) {
...
exports.newComment = catchAsync(async (req, res, next) => {
    ...
    if (post.comments.includes(req.params.userId)) {
...
exports.saveUnsavePost = catchAsync(async (req, res, next) => {
    ...
    if (user.saved.includes(post._id.toString())) {
        ...
        post.savedBy = post.savedBy.filter((p) => p.toString() !== req.params.userId.toString())
        await user.save();
        await post.save();
        ...
        post.savedBy.push(req.params.userId)
